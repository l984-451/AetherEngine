...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "4.5.3")
```
...
Pin to `.upToNextMinor(from: "4.5.3")` for stricter teams that prefer to opt into minor bumps explicitly.
